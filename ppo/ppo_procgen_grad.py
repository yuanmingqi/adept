...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(f"ppo_runs_grad/{run_name}")
    writer.add_text(
        "hyperparameters",
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        if iteration <= 762:
            args.update_epochs = 3
        elif 762 < iteration <= 1270:
    ...
    # save model
    torch.save(agent.state_dict(), (f"ppo_runs_grad/{run_name}/model.pth"))