...
if __name__ == "__main__":
    ...
    nue = args.update_epochs
    log_dir = f"ppo_runs_nue_{nue}"
    ...
    for iteration in range(1, args.num_iterations + 1):
        # save the intermediate model for 20 times
        if iteration % (args.num_iterations // 50) == 0:
            torch.save(agent.state_dict(), (f"{log_dir}/{run_name}/model_{iteration}.pth"))
