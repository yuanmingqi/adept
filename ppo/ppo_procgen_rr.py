...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # round-robin to select update_epochs
        all_update_epochs = [3, 2, 1]
        args.update_epochs = all_update_epochs[(iteration - 1) % len(all_update_epochs)]
        # print(f"iteration={iteration}, update_epochs={args.update_epochs}")
        ...
        # print(total_time, np.round(np.array([sample_time, action_time, env_time, bs_time, update_time, record_time]) / total_time * 100, 1))
        print(total_time, np.round(np.array([sample_time, update_time]), 2), args.update_epochs)
