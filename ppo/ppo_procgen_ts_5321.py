...
from ts import GaussianThompsonSampling
...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(f"ts_5321/{run_name}")
    writer.add_text(
        "hyperparameters",
    ...
    # TS setup
    hp_ts = GaussianThompsonSampling(param_values=[5, 3, 2, 1], window_size=10)
    ...
    # save model
    torch.save(agent.state_dict(), (f"ts_5321/{run_name}/model.pth"))
