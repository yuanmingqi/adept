...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        ucb_action_idx, args.update_epochs = hp_ucb.select_ucb_hp()
        writer.add_scalar("charts/ucb_action_idx", ucb_action_idx, global_step)
        writer.add_scalar("charts/update_epochs", args.update_epochs, global_step)
        print(f'iteration={iteration}, ucb_action_idx={ucb_action_idx}, update_epochs={args.update_epochs}', hp_ucb.ucb_action)
